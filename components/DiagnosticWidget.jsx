  ...
  bender: [
    {
      ...
      cause:
        "Electromagnetic clutch coil resistance degraded below 15Ω or clutch plate gap exceeds 0.4 mm tolerance.",
    ...
    },
    {
      ...
      cause:
        "Drive shaft key sheared or gearbox input pinion stripped under overload conditions.",
    ...
    },
    {
      ...
      cause:
        "Return spring tension unequal, or angular limit switch cam out of calibration position.",
    ...
    },
    {
      ...
      cause:
        "Induction motor capacitor failed (for single-phase units) or short in main winding.",
    ...
    },
    {
      ...
      cause:
        "Central bending pin bearing worn, or debris lodged in gearbox oil bath.",
  ...
  cutter: [
    {
      ...
      cause:
        "Eccentric gear key failed, or flywheel-to-crankshaft coupling bolts sheared under peak load.",
    ...
    },
    {
      ...
      cause:
        "Blade shimming incorrect after blade replacement, or wear has closed the clearance below 5% of bar diameter.",
    ...
    },
    {
      ...
      cause:
        "Blade edge radius exceeded 0.5 mm or blade material work-hardened beyond service limit.",
    ...
    },
    {
      ...
      cause:
        "Motor phase voltage imbalance greater than 3% or motor de-rated from previous rewind.",
    ...
    },
    {
      ...
      cause:
        "Brake pad dragging on flywheel rim, or clutch spring tension insufficient.",
  ...
  motor: [
    {
      ...
      cause:
        "Single-phasing condition (one phase open) or starting capacitor failed in single-phase motor.",
    ...
    },
    {
      ...
      cause:
        "Overloading, reduced ventilation from clogged cooling fins, or inter-turn short in stator winding.",
    ...
    },
    {
      ...
      cause:
        "Moisture ingress, chemical contamination, or thermal degradation of winding insulation (Class F limit 155°C).",
    ...
    },
    {
      ...
      cause:
        "Grease degraded in sealed bearing, or bearing race spalled from overloading.",
    ...
    },
    {
      ...
      cause:
        "Phase sequence of two supply leads reversed relative to winding reconnection.",
